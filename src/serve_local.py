...
batches_csv_path = "dataset/fastapi-test/kafka_testing_dataset.csv"

# model_uri_svr_lag = "src/"
# model_uri_xgb_lag = "src/"
# model_uri_randomforest_lag = "src/"
...
# df[MODEL_CONFIG[ModelNameChoice.linear_svr.value]["prediction_col"]] = np.nan
# df[MODEL_CONFIG[ModelNameChoice.xgboost.value]["prediction_col"]] = np.nan

# Load models ONCE
# print(f"Loading model: SVR")
# model_svr = mlflow.pyfunc.load_model(model_uri_svr)
# print(f"Loading model: XGBoost")
# model_xgb = mlflow.pyfunc.load_model(model_uri_xgb)

# X_test = df[features]
# print("Predicting with SVR...")
# svr_pred_col = MODEL_CONFIG[ModelNameChoice.linear_svr.value]["prediction_col"]
# df[svr_pred_col] = model_svr.predict(X_test)

# print("Predicting with XGBoost...")
# xgb_pred_col = MODEL_CONFIG[ModelNameChoice.xgboost.value]["prediction_col"]
# df[xgb_pred_col] = model_xgb.predict(X_test)
...
async def wind_generation_plot(model_name: ModelNameChoice, year: int, month: int, range_day_start: int, range_day_stop: int):
    ...
    return StreamingResponse(img, media_type="image/png")  # Create the image response
