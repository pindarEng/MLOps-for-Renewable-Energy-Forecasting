...
mlflow.set_experiment("LinearSVR Wind Generation Prediction-4")
print("setup complete")
with mlflow.start_run(run_name=f"linearsvr_model-{ver}"):
    print("started run")

    mlflow.sklearn.pyfunc.log_model("linearSVR_withScaler_batches",python_model=ModelWithScaler(model = best_svr, scaler= scaler))
    print("logged model")
